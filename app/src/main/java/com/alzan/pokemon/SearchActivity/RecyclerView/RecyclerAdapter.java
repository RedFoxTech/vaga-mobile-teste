package com.alzan.pokemon.SearchActivity.RecyclerView;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerHolder> {
    ...
    private ArrayList<SearchItems> pokeItems;
    SearchItems items;
    Context context;
    ...
    public void onBindViewHolder(final RecyclerHolder holder, final int position) {
        ...
        String pokeImageUrl = "https://img.pokemondb.net/artwork/" + items.getName() + ".jpg";
